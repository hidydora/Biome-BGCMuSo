	                 ...
	                 cflux_struct* cf, nflux_struct* nf, epvar_struct* epv, ntemp_struct* nt, double naddfrac)
{
	...
	double g2;          /* RATIO   proportion of growth resp to release at fixation */  
	...
	fluxes that get released on a given day are calculated in growth_resp(), but that the storage of C for growth resp during display of transferred growth is assigned here. */
