	            ...
	            const nstate_struct* ns, const nflux_struct* nf, const wflux_struct* wf, const epvar_struct* epv, summary_struct* summary)
{
	...
	double Closs_THN, Closs_MOW, Closs_HRV, Closs_PLG, Closs_GRZ, Cplus_PLT, Cplus_FRZ, Cplus_GRZ, Nplus_GRZ, Nplus_FRZ;
	...
	summary->sminn_top10 = ns->sminNH4[0] + ns->sminNH4[1] + ns->sminNH4[2] + 
		                   ns->sminNO3[0] + ns->sminNO3[1] + ns->sminNO3[2];
	...
	summary->cum_Closs_THN += Closs_THN;
	...
	summary->cum_Closs_MGM += Closs_THN + Closs_MOW + Closs_HRV + Closs_PLG + Closs_GRZ;
