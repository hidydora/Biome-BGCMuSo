...
int grazing(const control_struct* ctrl, const epconst_struct* epc, 
			grazing_struct* GRZ, cflux_struct* cf, nflux_struct* nf, wflux_struct* wf, cstate_struct* cs, nstate_struct* ns, wstate_struct* ws);

int harvesting(const control_struct* ctrl, const epconst_struct* epc, const harvesting_struct* HRV, 
	           epvar_struct* epv, cflux_struct* cf, nflux_struct* nf, wflux_struct* wf,  cstate_struct* cs, nstate_struct* ns, wstate_struct* ws);

int ploughing(const control_struct* ctrl, const epconst_struct* epc, siteconst_struct* sitec, 
	          metvar_struct* metv, epvar_struct* epv, ploughing_struct* PLG, 
			  cflux_struct* cf, nflux_struct* nf, wflux_struct* wf, cstate_struct* cs, nstate_struct* ns, wstate_struct* ws);
...
int cnw_summary(int yday, const metvar_struct* metv, const cstate_struct* cs, const cflux_struct* cf, 
